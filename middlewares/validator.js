...
//This is validation middleware for the actor
exports.actorInfoValidator = [
  check("name").trim().not().isEmpty().withMessage("Name is missing"),
  check("about").trim().not().isEmpty().withMessage("Email is missing"),
  check("gender").trim().not().isEmpty().withMessage("Gender is missing"),
];

//This is validation middleware which will validate movie data
exports.validateMovie = [
  ...
  check("genres")
    ...
    .custom((value) => {
      console.log("Reaching validation");
      //verifying that whether the provided elements in array have valid genres
      for (let g of value) {
  ...
  check("tags")
    ...
    //Verifying if the tags are valid i.e. string
    .custom((tags) => {
      for (let tag of tags) {
...
//This is validation middleware used to validate trailer details
...
//This is validation middleware used to validate the req.body from password form
...
//This is validation middleware used to validate the req.body from review form
